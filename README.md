...
`ship.rb` and `code-porter.rb` are refreshed by GitHub Actions in this repository (schedule + manual dispatch) from each app's latest GitHub Release and checksum file.
